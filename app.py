...
image_base64 = get_base64_image(r"C:\Users\new\VS\vscode.project\RESUME PROJCT\Coustomer segmention useing k means\k_means_clustering.jpg")
set_background(image_base64)

# Load the dataset
df = pd.read_csv(r"C:\Users\new\VS\vscode.project\RESUME PROJCT\Coustomer segmention useing k means\Customers.csv")
...
st.write("<h4 style='text-align: center;'>Analyze customer data to group them into clusters based on Annual Income and Spending Score.</h4>", unsafe_allow_html=True)
